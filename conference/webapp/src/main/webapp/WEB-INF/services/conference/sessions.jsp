...
<kme:page title="Sessions" id="conference" backButton="true" backButtonURL="${pageContext.request.contextPath}/conference" homeButton="true" cssFilename="conference">
	<kme:content>
		...
		<div id="daySelectTabs">
			<a class="${param.date eq '112811' ? 'selected' : ''}" href="?date=112811">Monday</a><a class="${param.date eq '112911' ? 'selected' : ''}" href="?date=112911">Tuesday</a><a class="${empty param.date ? 'selected' : ''}" href="?date=">All</a>
		</div>
		<kme:listView>
