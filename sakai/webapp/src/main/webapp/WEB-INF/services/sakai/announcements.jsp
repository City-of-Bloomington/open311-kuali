...
<kme:page title="Announcements" id="announcements" backButton="true" homeButton="true" backButtonURL="${pageContext.request.contextPath}/myclasses/${siteId}" cssFilename="sakai">
	<kme:content>
