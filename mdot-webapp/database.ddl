...
/
insert into CONFIG_PARAM_MAINT_T (CONFIG_PARAM_ID, NAME, VALUE, VER_NBR) values (SEQ_CONFIG_PARAM_MAINT_T.NEXTVAL, 'Bus.BT.03', '<a class="icon-PDF" href="http://www.bloomingtontransit.com/2_Aug_2009.pdf"><h3 class="wrap">Route 2 South - South Rogers / Countryview</h3></a>', 0)
/
...
/
insert into CONFIG_PARAM_MAINT_T (CONFIG_PARAM_ID, NAME, VALUE, VER_NBR) values (SEQ_CONFIG_PARAM_MAINT_T.NEXTVAL, 'Bus.BT.10', '<a class="icon-PDF" href="http://www.bloomingtontransit.com/6_Aug_2009.pdf"><h3 class="wrap">Route 6 Campus Shuttle and 6 Limited</h3></a>', 0)
/
insert into CONFIG_PARAM_MAINT_T (CONFIG_PARAM_ID, NAME, VALUE, VER_NBR) values (SEQ_CONFIG_PARAM_MAINT_T.NEXTVAL, 'Bus.BT.11', '<a class="icon-PDF" href="http://www.bloomingtontransit.com/7_Aug_2009.pdf"><h3 class="wrap">Route 7 Henderson/Walnut Express</h3></a>', 0)
/
...
/
insert into CONFIG_PARAM_MAINT_T (CONFIG_PARAM_ID, NAME, VALUE, VER_NBR) values (SEQ_CONFIG_PARAM_MAINT_T.NEXTVAL, 'Bus.BT.13', '<a class="icon-PDF" href="http://www.bloomingtontransit.com/6_and_9_summer_2011"><h3 class="wrap">Route 9 IU Campus/College Mall Campus Corner</h3></a>', 0)
/
insert into CONFIG_PARAM_MAINT_T (CONFIG_PARAM_ID, NAME, VALUE, VER_NBR) values (SEQ_CONFIG_PARAM_MAINT_T.NEXTVAL, 'Bus.BT.14', '<a class="icon-PDF" href="http://www.bloomingtontransit.com/6_and_9_summer_2011"><h3 class="wrap">Route 9 Limited</h3></a>', 0)
/
